...
HD_PWD='C:/Users/kartg/Desktop/Github/Deep-Learning-IC/hw10/project_hw10/project_hw10.runs/conv_design_axi_bram_ctrl_1_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_design_axi_bram_ctrl_1_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_design_axi_bram_ctrl_1_bram_0.tcl
