...
HD_PWD='C:/Users/kartg/Desktop/Github/Deep-Learning-IC/hw10/project_hw10/project_hw10.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log conv_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_design_wrapper.tcl
