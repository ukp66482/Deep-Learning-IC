...
HD_PWD='C:/Users/kartg/Desktop/Github/Deep-Learning-IC/hw10/project_hw10/project_hw10.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log conv_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv_design_wrapper.tcl -notrace
