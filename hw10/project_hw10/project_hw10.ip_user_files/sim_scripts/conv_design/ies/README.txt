...
#
# Generated by export_simulation on Sun May 25 02:39:58 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './conv_design.sh' script.

./conv_design.sh -reset_run
...
./conv_design.sh -noclean_files

For more information on the script, please type './conv_design.sh -help'.
