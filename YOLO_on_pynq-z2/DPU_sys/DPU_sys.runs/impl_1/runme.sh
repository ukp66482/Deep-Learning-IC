...
HD_PWD='C:/Users/kartg/Desktop/Github/Deep-Learning-IC/YOLO_on_pynq-z2/DPU_sys/DPU_sys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DPU_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DPU_sys_wrapper.tcl -notrace
