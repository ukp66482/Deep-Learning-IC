...
HD_PWD='C:/Users/kartg/Desktop/Github/Deep-Learning-IC/YOLO_on_pynq-z2/DPU_sys/DPU_sys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DPU_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DPU_sys_wrapper.tcl
