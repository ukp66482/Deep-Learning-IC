...
HD_PWD='C:/Users/kartg/Desktop/Github/Deep-Learning-IC/hw3/project_hw3/project_hw3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log runningled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source runningled.tcl
