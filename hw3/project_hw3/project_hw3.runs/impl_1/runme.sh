...
HD_PWD='C:/Users/kartg/Desktop/Github/Deep-Learning-IC/hw3/project_hw3/project_hw3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log runningled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source runningled.tcl -notrace
