...
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { mode }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]

##RGB LEDs

# set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { test }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
...
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { button0 }]; #IO_L4P_T0_35 Sch=btn[0]
set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { button1 }]; #IO_L4N_T0_35 Sch=btn[1]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports { button2 }]; #IO_L9N_T1_DQS_AD3N_35 Sch=btn[2]
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { button3 }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
