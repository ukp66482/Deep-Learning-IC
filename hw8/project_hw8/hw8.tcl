...
proc create_root_design { parentCell } {
  ...
  set block_name mul16
  set block_cell_name mul16_0
  if { [catch {set mul16_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins mul16_0/R_data]
  connect_bd_net -net mul16_0_R_req [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins mul16_0/R_req]
  connect_bd_net -net mul16_0_W_data [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins mul16_0/W_data]
  connect_bd_net -net mul16_0_W_req [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins mul16_0/W_req]
  connect_bd_net -net mul16_0_addr [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins mul16_0/addr]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins mul16_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins mul16_0/rst] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins rst_ps7_0_100M/peripheral_reset]
